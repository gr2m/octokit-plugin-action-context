...
1. Please make sure there is no [open issue](https://github.com/gr2m/octokit-plugin-action-context/issues?utf8=%E2%9C%93&q=is%3Aissue) yet.
...
```shell
git clone https://github.com/<your account name>/octokit-plugin-action-context.git
cd octokit-plugin-action-context
npm install
```
...
- Submit a pull request from your topic branch to the master branch on the `gr2m/octokit-plugin-action-context` repository.
- Be sure to tag any issues your pull request is taking care of / contributing to. Adding "Closes #123" to a pull request description will automatically close the issue once the pull request is merged in.

## Testing a pull request from github repo locally:

You can install `octokit-plugin-action-context` from each pull request. Replace `[PULL REQUEST NUMBER]`

Once you are done testing, you can revert back to the default module `octokit-plugin-action-context` from npm with `npm install octokit-plugin-action-context`
